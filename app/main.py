...
from app.api.phones import phones
...
app = FastAPI(openapi_url="/api/v1/phones/openapi.json", docs_url="/api/v1/phones/docs")
...
app.include_router(phones, prefix='/api/v1/phones', tags=['phones'])